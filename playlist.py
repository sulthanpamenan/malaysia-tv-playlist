...
CHANNELS = [
    ...
    {"name": "Drama Sangat", "slug": "drama-sangat", "group": "Drama", "logo": "https://example.com/drama-sangat.png", "type": "tv"},
    ...
    {"name": "TV Okey", "slug": "okey", "group": "Local", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Selangor TV", "slug": "selangor", "group": "Local", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "TV IKIM", "slug": "ikim-live", "group": "Religious", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "8 TV", "slug": "8-tv", "group": "General", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "TV Sarawak", "slug": "tv-sarawak-live", "group": "Local", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "MPL Malaysia", "slug": "mpl-malaysia", "group": "Sports", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "CNA", "slug": "cna", "group": "News + Opinion", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "PPA KL Cup", "slug": "ppa-kl-cup", "group": "Live Events", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "DW", "slug": "dw", "group": "News + Opinion", "logo": "https://example.com/tvokey.png", "type": "tv"},
    ...
    {"name": "Al Jazeera", "slug": "al-jazeera", "group": "News + Opinion", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "BeIN Sports 1", "slug": "being-sports-1", "group": "Sports", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Tennis+", "slug": "tennis", "group": "Sports", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Pickle TV", "slug": "pickle-tv", "group": "Sports", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Cricket Gold", "slug": "cricket-live", "group": "Sports", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Shemaroo Bollywood Classic", "slug": "shemaroo-bollywood-classic", "group": "Classic TV", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Bollywood Prime", "slug": "bollywood-prime-live", "group": "Movies", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Bollywood Masala", "slug": "bollywood-masala-live", "group": "Movies", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Shemaroo Filmigaane", "slug": "shemaroo-filmigaane-live", "group": "Music Videos", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Pitaara Movie", "slug": "pitaara-movie-live", "group": "Movies", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Shemaroo Umang Plus", "slug": "shemaroo-umang-plus-live", "group": "Drama", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Mastiii TV", "slug": "mastiii-tv-live", "group": "Music Videos", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Miramax Movie", "slug": "miramax-movie", "group": "Movies", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "FILMRISE Movies", "slug": "filmrise-movies", "group": "Movies", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "GoUSA TV", "slug": "gousa-tv-live", "group": "Lifestyle", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "euro News", "slug": "euro-news-live", "group": "News + Opinion", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "ION NCIS", "slug": "ion-ncis", "group": "Drama", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "Nosey TV", "slug": "nosey-tv", "group": "Entertainment", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "FailArmy Channel", "slug": "failarmy-tv", "group": "Comedy", "logo": "https://example.com/tvokey.png", "type": "tv"},
    {"name": "BBC News", "slug": "bbc-news-live", "group": "News + Opinion", "logo": "https://example.com/tvokey.png", "type": "tv"},
